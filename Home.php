...
<head>
	...
	html{
		height:100%;
		background: #ffffff url(http://ardorbin.com/wp-content/uploads/2017/06/lal.jpg); no-repeat center bottom fixed;
	...
	#cspio-page{
	    background: -moz-radial-gradient(ellipse at center, rgba(0, 0, 0, 0) 0%,rgba(0, 0, 0, 0.2) 37%,rgba(0,0,0,0) 68%,rgba(0,0,0,0) 100%);
	    background: -webkit-radial-gradient(ellipse at center, rgba(0, 0, 0, 0) 0%,rgba(0, 0, 0, 0.2) 37%,rgba(0,0,0,0) 68%,rgba(0,0,0,0) 100%);
	    background: radial-gradient(ellipse at center, rgba(0, 0, 0, 0) 0%,rgba(0, 0, 0, 0.2) 37%,rgba(0,0,0,0) 68%,rgba(0,0,0,0) 100%);
	}
...
<body style="overflow-x: hidden;">
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="http://ardorbin.com/wp-content/uploads/2017/06/latric.png" style="margin-top: 30px;">
			    				
			<h1 id="cspio-headline" style="color:000;">Coming Soon</h1>   				
			...
			<!-- <form id="cspio-form" action="" method="post">
				<div id="cspio-field-wrapper">
					<div class="row">
						<div class="col-md-12 seperate"><div style="position: relative;
    display: table;
    border-collapse: separate;
    width: 45%;
    margin: 0 auto;">
							<input id="cspio-email" name="EMAIL" class="form-control input-lg form-el" type="email" placeholder="Email" required/>
					<span class="input-group-btn">
						<button id="cspio-subscribe-btn" type="submit" class="btn btn-lg btn-primary form-el noglow">Notify Me</button></span></div></div>
					</div>
				</div>
			</form> -->
 ...
 -->
			<!-- <div id="cspio-credit">
					<span>Designed and Developed by <a target="_blank" href="https://www.comingsoonpage.com"></a> Webb4biz.com <a target="_blank" href="https://www.webb4biz.com" style="text-decoration:underline" alt="Get your free coming soon page."></a>
				</span></div> -->
